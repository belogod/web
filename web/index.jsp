...
<html>
  ...
  <div id="content">Перево́дчик — специалист, занимающийся переводом, то есть созданием письменного или устного текста на определённом языке (называемом языком перевода), эквивалентного письменному или устному тексту на другом языке (языке-источнике).
  ...
  <a href="main" class="ssylka1">Клиенты</a>
  <a href="books" class="ssylka2">Книги</a>
